...
// Cross Module References
	REAPER_API UFunction* Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature();
	UPackage* Z_Construct_UPackage__Script_Reaper();
	REAPER_API UClass* Z_Construct_UClass_UTerminal_NoRegister();
	REAPER_API UClass* Z_Construct_UClass_UTerminal();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	REAPER_API UFunction* Z_Construct_UFunction_UTerminal_ActivateTerminal();
	REAPER_API UFunction* Z_Construct_UFunction_UTerminal_DeactivateTerminal();
	REAPER_API UFunction* Z_Construct_UFunction_UTerminal_GetScreenText();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics
	{
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::NewProp_Text = { "Text", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Reaper_eventTextUpdateSignature_Parms, Text), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::NewProp_Text,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Terminal.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Reaper, nullptr, "TextUpdateSignature__DelegateSignature", nullptr, nullptr, sizeof(_Script_Reaper_eventTextUpdateSignature_Parms), Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature_Statics::FuncParams);
		}
	...
	UObject* (*const Z_Construct_UClass_UTerminal_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_Reaper,
	};
	const FClassFunctionLinkInfo Z_Construct_UClass_UTerminal_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTerminal_ActivateTerminal, "ActivateTerminal" }, // 3022856414
		{ &Z_Construct_UFunction_UTerminal_DeactivateTerminal, "DeactivateTerminal" }, // 242104578
		{ &Z_Construct_UFunction_UTerminal_GetScreenText, "GetScreenText" }, // 2386970113
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTerminal_Statics::NewProp_TextUpdated = { "TextUpdated", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTerminal, TextUpdated), Z_Construct_UDelegateFunction_Reaper_TextUpdateSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UTerminal_Statics::NewProp_TextUpdated_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTerminal_Statics::NewProp_TextUpdated_MetaData)) };
	...
	IMPLEMENT_CLASS(UTerminal, 132806302);
	template<> REAPER_API UClass* StaticClass<UTerminal>()
	{
		return UTerminal::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTerminal(Z_Construct_UClass_UTerminal, &UTerminal::StaticClass, TEXT("/Script/Reaper"), TEXT("UTerminal"), false, nullptr, nullptr, nullptr);
